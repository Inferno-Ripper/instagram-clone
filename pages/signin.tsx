...
const Signin = () => {
	...
	return (
		<>
			<Head>
				<title>Instgram | Sign In</title>
				<meta name='description' content='Generated by create next app' />
				<link rel='icon' href='instagram-logo-favicon.png' />
			</Head>
			<div className='flex flex-col gap-4 text-black bg-dark-white dark:bg-dark-dark dark:text-white'>
				<Header />
					...
					<div className='flex flex-col items-center justify-center gap-4 '>
						<div className='flex flex-col items-center h-auto gap-8 p-10 border border-gray-200 bg-full-white dark:border-dark-border dark:bg-dark-light w-96'>
							...
							<div className='flex items-center justify-center w-full gap-4'>
								...
								<p
									className='text-[#3A5897] font-bold cursor-pointer  hover:text-[#3474ff] transition-all duration-300'
							...
							<p className='transition-all duration-300 cursor-pointer hover:text-red-400'>
								Forgot Password?
							</p>
						...
						>
							...
							{loginMethod === 'register' && (
								<>
									...
									<p className='text-[#3A5897] hover:text-[#3474ff] transition-all duration-300 font-bold cursor-pointer'>
										Login
									</p>
								</>
							)}
